...
**Retro #006 trigger REACHED — fires next session.** (v0.3.5 = #22; v0.3.6 = #23; v0.3.7 = #24; v0.3.8 = #25 — Retro #005 fired ON TIME 2026-06-02; v0.3.9 = #26; v0.3.10 = #27; v0.3.11 = #28; v0.3.12 = #29; **v0.3.13 = #30 — Retro #006 trigger**. Hard line from Retro #005 in effect: Retro #006 must fire on time. `[hard-line-declaration]` codified v0.3.10; the counter mechanism above is itself an instance of the pattern. Retro #006 covers v0.3.9 → v0.3.13 cycle.)
