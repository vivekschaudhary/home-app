...
_History above is the dogfood trail that drove the MVP loose-ends + WLT-14/WLT-15/OPS-1 — captured here retroactively so the rhythm has precedent. New items start at SUP-7._
