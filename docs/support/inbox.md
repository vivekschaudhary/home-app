...
| SUP-7 | 2026-06-15 | dogfood | "change password page… enter the password and save, gives a 502 on the post" | bug | P1 | closed | `/fix` → PR #52 (discriminate `updateUser` errors; same-password → clear message) |
