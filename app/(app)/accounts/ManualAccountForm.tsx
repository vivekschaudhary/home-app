...
export function ManualAccountForm({
  ...
  return (
    <div ref={formRef} role="dialog" aria-modal="true" aria-labelledby="manual-account-form-title" className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
