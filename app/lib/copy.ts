...
export const COPY = {
  ...
  // WLT-27-4 — CSV Import Wizard. Strings derived from story ACs (no separate copy.md for MVP).
  csvWizard: {
    step1Title: "Upload your CSV",
    step2Title: "Map columns",
    step3Title: "Preview",
    step4Title: "Confirm import",
    stepIndicator: "Step {step} of 4",
    fileLabel: "Select a CSV file",
    rowCapNotice: "Maximum 10,000 rows per import. Large files can be split.",
    rowCountInfo: "{count} rows found",
    errorParse: "We couldn't read that file — check that it's a valid CSV.",
    errorEmpty: "No rows found in this file.",
    mapDate: "Date column",
    mapDescription: "Description column",
    mapAmount: "Amount column",
    mapDirection: "Direction column",
    mapDebit: "Debit column",
    mapCredit: "Credit column",
    mapCategory: "Category column",
    unmapped: "— not mapped —",
    splitToggleLabel: "Split debit/credit columns",
    presetBanner: "Apple Card format detected — mappings pre-filled.",
    presetBannerDismiss: "Dismiss",
    colDate: "Date",
    colDescription: "Description",
    colAmount: "Amount",
    colDirection: "Direction",
    warnBadDirection: "Direction unclear",
    importCta: "Import {count} transactions",
    importing: "Importing…",
    slowUpload: "Still uploading…",
    successSummary: "{inserted} transactions imported, {superseded} already seen.",
    successAllDuplicate: "All {total} rows were already imported — no duplicates added.",
    doneCta: "Done",
    errorRowLimit: "This file has more than 10,000 rows. Please split it into smaller files and import each separately.",
    errorNetwork: "Upload failed — please try again.",
    errorServer: "Something went wrong on our end — please try again.",
    previewMore: "Showing first 10 of {count} rows.",
    readyToImport: "Ready to import {count} {currency} rows.",
    retry: "Try again",
    back: "Back",
    cancel: "Cancel",
    next: "Next",
  ...
  csvWizardA11y: {
    ...
    directionError: "direction unclear",
  },
} as const;
