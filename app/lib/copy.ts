...
export const COPY = {
  ...
  // WLT-27-2 — Manual Account Entry. docs/bets/WLT-27/stories/WLT-27-2/copy.md verbatim.
  manualAccount: {
  ...
  // WLT-27-4 — CSV Import Wizard. docs/bets/WLT-27/stories/WLT-27-4/copy.md verbatim.
  csvWizard: {
    triggerCta: "Import transactions",
    ...
    cancelCta: "Cancel",
    doneCta: "Done",
    step1Heading: "Upload a CSV file",
    rowCapNotice: "Up to 10,000 rows per import. Split larger files and import each part.",
    parseError: "We couldn't read that file. Make sure it's a valid CSV and try again.",
    emptyFile: "No transactions found in this file. Select a different file to continue.",
    step2Heading: "Map your columns",
    presetDetectedBanner: "Apple Card format detected — columns pre-filled.",
    splitColumnsToggle: "My CSV uses separate debit and credit columns",
    notMappedOption: "— not mapped —",
    step3Heading: "Preview",
    previewDirectionWarning: "Direction couldn't be determined",
    step4Heading: "Confirm import",
    importCta: "Import {N} transactions",
    importingLabel: "Importing…",
    slowUpload: "Still importing — this can take a moment.",
    success: "{N} transactions imported, {M} already in your history.",
    successAllSeen: "All {N} transactions are already in your history — nothing new was added.",
    errorRowLimit: "This file has more than 10,000 rows. Split it into smaller parts and import each one.",
    errorNetwork: "Import failed — check your connection and try again.",
    errorServer: "Our server couldn't complete the import — try again in a moment.",
  },
  // WLT-27-5 — Region Switcher. docs/bets/WLT-27/stories/WLT-27-5/copy.md verbatim.
  regionSwitcher: {
    label: "Currency",
    ariaLabel: "View spending in a different currency",
  },
} as const;
