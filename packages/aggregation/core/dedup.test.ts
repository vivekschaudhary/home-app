...
describe("dedupKey", () => {
  ...
  it("WLT-27-3 Plaid regression: non-null providerAccountId still produces the old key (fix is a no-op for Plaid)", () => {
    // Before the fix, the key was source:providerAccountId:providerTransactionId.
